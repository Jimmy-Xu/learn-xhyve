...
CMDLINE="earlyprintk=serial console=ttyS0 acpi=off root=/dev/mapper/centos-root rd.lvm.lv=centos/root rd.lvm.lv=centos/swap rw"
MEM="-m 1G"
SMP="-c 2"
NET="-s 2:0,virtio-net"
#IMG_CD="-s 3,ahci-cd,/Users/xjimmy/iso/CentOS-7-x86_64-Minimal-1511.iso"
